function tcomments (ptweets, tplace) {
  ...
  function buildPieChart(datapie, placepie) {
    ...
    var data = [{
        ...
        type: 'pie',
        marker: {
          colors: ['rgb(255,175,0)', 'rgb(255,102,102)', 'rgb(153,255,153']
        }
      }];
      ...
      var layout = {
        height: 400,
        width: 500,
        paper_bgcolor: 'rgb(245,241,224)',
        plot_bgcolor: 'rgb(245,241,224)'
      };
  ...
  function buildLineChart(placel){
    ...
    var trace1 = {
      ...
      marker: { color:"rgb(255,102,102)", simbol: "diamond-x"}
    };
    ...
    var trace2 = {
      ...
      marker: { color:"rgb(153,255,153)", simbol: "hexagram"}
    };
    ...
    var trace3 = {
      ...
      y: neu1,
      // line: {color: "yellow"},
      line: {color: "rgb(255,175,0)"},
      marker: { color:"rgb(255,175,0)", simbol: "cross"}
    };

    var data = [trace1, trace2, trace3];

    var layout = {
      title: "Twitter's Sentiment of BTC",
      xaxis: {
        title: "Number of Observations",
        dtick: 1.0},
      yaxis: {title: "Sentiment Split (%)"},
      paper_bgcolor: 'rgb(245,241,224)',
      plot_bgcolor: 'rgb(245,241,224)'
